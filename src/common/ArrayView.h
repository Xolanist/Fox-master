...
namespace Common
{
    ...
    template<class Object = uint8_t, class Size = uint64_t> class ArrayView
    {
      public:
        ...
        // The behavior is undefined unless 'other' 'ArrayView' is in defined state, that is 'data' != 'nullptr' ||
        // 'size' == 0
