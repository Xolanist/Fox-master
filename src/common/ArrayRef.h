...
namespace Common
{
    ...
    template<class ObjectType = uint8_t, class SizeType = uint64_t> class ArrayRef
    {
      public:
        ...
        // The behavior is undefined unless 'arrayData' != 'nullptr' || 'arraySize' == 0. Input state can be malformed
        // using poiner conversions.
        ...
        // The behavior is undefined unless 'other' 'ArrayRef' is in defined state, that is 'data' != 'nullptr' ||
        // 'size' == 0
    ...
    template<class Object, class Size> const SizeArrayRef<Object, Size>::INVALID = std::numeric_limits<Size>::max();
