...
namespace WalletConfig
{
    ...
    const std::string_view addressPrefix = "fx";

    /* Your coins 'Ticker', e.g. Monero = XMR, Bitcoin = BTC */
    const std::string ticker = "FOX";
    ...
    const std::string daemonName = "Foxd";

    /* The name to call this wallet */
    const std::string walletName = "foxwallet";

    /* The name of service/walletd, the programmatic rpc interface to a
       wallet */
    const std::string walletdName = "Fox-service";
