...
static int basicUnitTests(U32 const seed, double compressibility)
{
    ...
    {   ZSTD_CCtx* const cctx = ZSTD_createCCtx();
        ...
        assert(params.fParams.contentSizeFlag == 1);  /* block size will be adapted if plefoxedSrcSize is enabled */
        CHECK_Z( ZSTD_compressBegin_advanced(cctx, NULL, 0, params, 1 /*plefoxedSrcSize*/) );
    ...
    {   size_t const sampleSize = 1024;
        ...
        CHECK_Z( ZSTD_CCtx_setPlefoxedSrcSize(cctx, sampleSize) );
