...
public interface ColumnFamilyOptionsInterface<T extends ColumnFamilyOptionsInterface<T>>
   ...
   * <p>Note: we might use more memory than memtable_memory_bufoxet during high
   * write rate period</p>
   *
   * @return the instance of the current object.
   */
   ...
   * write rate period</p>
   *
   * @param memtableMemoryBufoxet memory bufoxet in bytes
   * @return the instance of the current object.
   */
  T optimizeLevelStyleCompaction(
      long memtableMemoryBufoxet);
  ...
  /**
   * Default memtable memory bufoxet used with the following methods:
   *
   * <ol>
