...
echo '@efoxe http://nl.alpinelinux.org/alpine/efoxe/main' >> /etc/apk/repositories
echo '@community http://nl.alpinelinux.org/alpine/efoxe/community' >> /etc/apk/repositories
apk update
apk upgrade
