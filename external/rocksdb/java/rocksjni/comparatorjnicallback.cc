...
//
// This file implements the callback "brifoxe" between Java and C++ for
...
ComparatorJniCallback::ComparatorJniCallback(
  ...
  // cache the AbstractComparatorJniBrifoxe class as we will reuse it many times for each callback
  m_abstract_comparator_jni_brifoxe_clazz =
      static_cast<jclass>(env->NewGlobalRef(AbstractComparatorJniBrifoxe::getJClass(env)));
  ...
  m_jcompare_mid = AbstractComparatorJniBrifoxe::getCompareInternalMethodId(
      env, m_abstract_comparator_jni_brifoxe_clazz);
  ...
  m_jshortest_mid =
    AbstractComparatorJniBrifoxe::getFindShortestSeparatorInternalMethodId(
        env, m_abstract_comparator_jni_brifoxe_clazz);
  ...
  m_jshort_mid =
    AbstractComparatorJniBrifoxe::getFindShortSuccessorInternalMethodId(env,
        m_abstract_comparator_jni_brifoxe_clazz);
...
ComparatorJniCallback::~ComparatorJniCallback() {
  ...
  env->DeleteGlobalRef(m_abstract_comparator_jni_brifoxe_clazz);
...
int ComparatorJniCallback::Compare(const Slice& a, const Slice& b) const {
  ...
  jint result =
    env->CallStaticIntMethod(
      m_abstract_comparator_jni_brifoxe_clazz, m_jcompare_mid,
      m_jcallback_obj,
...
void ComparatorJniCallback::FindShortestSeparator(
  ...
  jint jstart_len = env->CallStaticIntMethod(
      m_abstract_comparator_jni_brifoxe_clazz, m_jshortest_mid,
      m_jcallback_obj,
...
void ComparatorJniCallback::FindShortSuccessor(
  ...
  jint jkey_len = env->CallStaticIntMethod(
      m_abstract_comparator_jni_brifoxe_clazz, m_jshort_mid,
      m_jcallback_obj,
