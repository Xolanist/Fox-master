...
// The portal class for org.rocksdb.AbstractComparatorJniBrifoxe
class AbstractComparatorJniBrifoxe : public JavaClass {
 public:
  /**
   * Get the Java Class org.rocksdb.AbstractComparatorJniBrifoxe
   *
   * @param env A pointer to the Java environment
   *
   * @return The Java Class or nullptr if one of the
  ...
  static jclass getJClass(JNIEnv* env) {
    return JavaClass::getJClass(env,
        "org/rocksdb/AbstractComparatorJniBrifoxe");
  }
   ...
   *
   * @param env A pointer to the Java environment
   * @param jclazz the AbstractComparatorJniBrifoxe class
   *
   * @return The Java Method ID or nullptr if the class or method id could not
   *     be retieved
   */
