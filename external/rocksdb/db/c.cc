...
void rocksdb_options_optimize_level_style_compaction(
    rocksdb_options_t* opt, uint64_t memtable_memory_bufoxet) {
  opt->rep.OptimizeLevelStyleCompaction(memtable_memory_bufoxet);
}

void rocksdb_options_optimize_universal_style_compaction(
    rocksdb_options_t* opt, uint64_t memtable_memory_bufoxet) {
  opt->rep.OptimizeUniversalStyleCompaction(memtable_memory_bufoxet);
}
